...
class VerifyIdentityRequest extends APIRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ver_document_frontside' => 'sometimes|required_if:is_document_upload,1|required|image|mimes:jpeg,png,jpg,gif,svg,pdf,PDF|max:2048',
            'ver_document_backside' => 'sometimes|required_if:is_document_upload,1|required|image|mimes:jpeg,png,jpg,gif,svg,pdf,PDF|max:2048',
