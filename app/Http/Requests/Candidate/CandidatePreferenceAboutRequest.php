...
class CandidatePreferenceAboutRequest extends APIRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'pre_partner_comes_from.*.country' => 'nullable|required_if:pre_has_country_allow_preference,1|numeric|exists:countries,id',
            'pre_partner_comes_from.*.city' => 'nullable|required_if:pre_has_country_allow_preference,1|numeric|exists:cities,id',
            'pre_has_country_disallow_preference' => 'nullable||boolean',
            'pre_disallow_countries.*.country' => 'nullable|required_if:pre_has_country_disallow_preference,1|numeric|distinct|exists:countries,id',
            'pre_disallow_countries.*.city' => 'nullable|required_if:pre_has_country_disallow_preference,1|numeric|distinct|exists:countries,id',
            'pre_partner_religions' => 'nullable|string',
            'pre_nationality' => 'nullable|array|min:1',
            'pre_nationality.*' => 'nullable|numeric|distinct|',
    ...
    public function messages()
    {
        return [
            ...
            'pre_disallow_countries.*.country' => 'Value should be valid country',
