...
<div style="color: rgb(96 84 84 / 85%); margin: 0 auto; width: 500px;">
    ...
    <div style="width: 100%; margin-top: 30px;">
        <h2 style="font-size: 20px; color: rgba(0,0,0,.5);">Subscription expiring at 20/03/2022</h2>
        ...
        <p style="font-size: 16px; color: rgba(0,0,0,.5); margin-top: 28px;">
            Thank you for using MatrimoyAssist [20-11-2021]
        </p>
        ...
        <p style="font-size: 16px; color: rgba(0,0,0,.5); margin-top: 28px;">
            Your subscription for the - <a href="" style="color: #522e8e;">Amina's Family (Team 1)</a> is expiring on <span style="color: #522e8e">20/03/2022, at 14:00 +06</span>
        </p>
